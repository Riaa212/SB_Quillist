...
import com.blogwebsite.user.domain.FollowRequest;
...
public class UserController {
	...
	@PostMapping("/followRequest/{id}")
	public ResponseEntity<?> sendFollowRequest(@RequestBody FollowRequest userrequest,@PathVariable("id") Integer userId)
	{
		return ResponseEntity.status(HttpStatus.OK).body(userImpl.sendFollowRequest(userrequest,userId));
	}
	
	@PostMapping("/acceptRequest/{id}")
	public ResponseEntity<?> acceptFollowRequest(@RequestBody FollowRequest userrequest,@PathVariable("id") Integer userId)
	{
		return ResponseEntity.status(HttpStatus.OK).body(userImpl.acceptRequest(userrequest, userId));
	}
