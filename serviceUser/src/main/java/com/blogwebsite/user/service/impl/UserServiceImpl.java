...
//	@Override
	...
	Integer count=0;
	//send follow request
	public String sendFollowRequest(FollowRequest fr,Integer userId)
	{	
		...
		if(userbyId.isPresent())
		{
			...
			return "followRequest Send successfully";
		}
		return "something went wrong";
	}
	
	public String acceptRequest(FollowRequest fr,Integer userId)
	{
		
	Optional<UserEntity> userbyId = userRepo.findById(fr.getRequestuserId());
