...
public class BlogController {
	...
	@PostMapping("/addrating/{id}") //working in angular 
	...
	@GetMapping("/getRatingByBlogId/{id}")
	public ResponseEntity<?> getRatingsByBlogId(@PathVariable("id") Integer blogId)
	{
		return ResponseEntity.status(HttpStatus.ACCEPTED).body(blogImpl.getRatingsByBlogId(blogId));
	}
//
//	public ResponseEntity<?> avgRating()
//	{
//		
//	}
